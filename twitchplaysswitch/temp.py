            print("HOLY SHIT THIS IS ACTUALLY WORKING " + str(latest_cmd))
...
try:
    ...
    def cmd_available(self):
        left_result, right_result = self.readline_noblock()

        if left_expected and 'ok' in left_result.lower():
            return True
        elif right_expected and 'ok' in right_result.lower():
            return True
